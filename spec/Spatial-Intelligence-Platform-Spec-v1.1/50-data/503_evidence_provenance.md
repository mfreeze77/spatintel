---
spec_id: DAT-EVID
title: "Evidence, Assertions, Provenance, and Chain of Derivation"
version: 1.1.0
...
normative: true
---
# Evidence, Assertions, Provenance, and Chain of Derivation

    ## 1. Purpose

    Defines how facts, memories, observations, measurements, inferences, and generation are supported and challenged.
    ...
    - Assertions and evidence are many-to-many.
- Evidence can support, contradict, contextualize, or supersede an assertion.
- Provenance is event-based and includes both machine transformations and human review.
- Authority, confidence, source class, and corroboration are separate dimensions.
...
| ----------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| DATEVID-001 | P0       | Every assertion shall include subject, predicate, value/object, time/validity, source class, author/producer, and status.                           | Controlled verification |
| DATEVID-002 | P0       | Every evidence record shall identify immutable source asset or record, relevant region/time range, contributor, consent/access, and integrity hash. | Automated test          |
| DATEVID-003 | P0       | A derivation event shall identify activity, agent, inputs, outputs, software/model, parameters, time, and validation.                               | Automated test          |
| DATEVID-004 | P1       | The UI shall allow users to inspect evidence behind a displayed assertion when authorized.                                                          | Controlled verification |
| DATEVID-005 | P1       | Disputed assertions shall remain retrievable and cannot be silently replaced by a favored narrative.                                                | Controlled verification |
| DATEVID-006 | P1       | A provenance gap shall prevent verified or corroborated status.                                                                                     | Automated test          |
    ...
    - A versioned `dat_evid_manifest` recording identity, timestamps, ownership, state, and provenance.
