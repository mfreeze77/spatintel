---
spec_id: CON-HIER
title: "Construction Project and Spatial Hierarchy"
version: 1.1.0
...
normative: true
---
# Construction Project and Spatial Hierarchy

    ## 1. Purpose

    Defines sites, buildings, levels, zones, rooms, shafts, exterior areas, systems, work packages, and naming reconciliation.
    ...
    - Project hierarchy supports owner names, drawing names, field labels, room-number revisions, and aliases.
- Spatial containment and system membership are separate relationships.
- Floor/room boundaries can be imported, captured, drawn, or inferred with source labels.
- A place identity can survive renovation and room renumbering through revisions and aliases.
...
| ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CONHIER-001 | P0       | Every place shall have stable ID, type, names/aliases, parent, validity, source, geometry/volume when known, access classification, and evidence.       | Controlled verification |
| CONHIER-002 | P0       | The system shall support multiple building coordinate frames and a site/global frame with explicit transforms.                                          | Controlled verification |
| CONHIER-003 | P0       | Room number conflicts across drawings, signage, and owner systems shall be reviewable mappings.                                                         | Controlled verification |
| CONHIER-004 | P1       | System zones such as fire-alarm notification, access-control areas, HVAC zones, and security partitions shall not be forced into geometric containment. | Controlled verification |
| CONHIER-005 | P1       | Bulk import from IFC, room schedules, CSV, and owner systems shall produce mapping/conflict reports.                                                    | Controlled verification |
| CONHIER-006 | P1       | Reports shall use the project naming view selected for the audience while retaining stable IDs.                                                         | Controlled verification |
    ...
    - A versioned `con_hier_manifest` recording identity, timestamps, ownership, state, and provenance.
