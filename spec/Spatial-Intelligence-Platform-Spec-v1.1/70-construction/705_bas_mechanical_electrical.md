---
spec_id: CON-MEP
title: "BAS, Mechanical, Electrical, and Equipment Documentation"
version: 1.1.0
...
normative: true
---
# BAS, Mechanical, Electrical, and Equipment Documentation

    ## 1. Purpose

    Defines equipment, controls, sensors, panels, power, piping/duct connections, service clearances, and cross-system interfaces.
    ...
    - Equipment identity links nameplate evidence, design tag, BAS point names, maintenance records, and spatial location without assuming they match.
- Clearance and pathway observations are reference data unless verified.
- Control sequences and live operational values are separate from captured geometry.
- Cross-system interfaces create explicit relationships and test records.
...
| ---------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| CONMEP-001 | P0       | Equipment records shall support tag/aliases, type, manufacturer/model/serial, capacities, serving/served relationships, power/control connections, clearances, nameplate media, documents, and status. | Controlled verification |
| CONMEP-002 | P0       | BAS points shall link to equipment and sensor/actuator entities with source and verification.                                                                                                          | Controlled verification |
| CONMEP-003 | P0       | The platform shall represent fire-alarm shutdown/monitoring, access-control interfaces, elevator interfaces, and other cross-system dependencies.                                                      | Controlled verification |
| CONMEP-004 | P1       | Spatial pathway or clearance measurements shall show scan/verified/design origin.                                                                                                                      | Controlled verification |
| CONMEP-005 | P1       | Trend or operational data imports shall retain source system, units, timestamps, quality flags, and retention separate from static scene commits.                                                      | Controlled verification |
| CONMEP-006 | P1       | Sensitive network and controller configuration shall use restricted access and redacted exports.                                                                                                       | Controlled verification |
    ...
    - A versioned `con_mep_manifest` recording identity, timestamps, ownership, state, and provenance.
