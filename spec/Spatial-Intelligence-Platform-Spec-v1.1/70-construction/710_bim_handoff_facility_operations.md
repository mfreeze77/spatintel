---
spec_id: CON-HAND
title: "BIM Handoff and Facility Operations"
version: 1.1.0
...
normative: true
---
# BIM Handoff and Facility Operations

    ## 1. Purpose

    Defines owner deliverables, asset records, accepted as-builts, O&M documents, tests, training media, open export, and ongoing updates.
    ...
    - Handoff is a signed release/tag over a specific scene commit and document/asset set.
- Owner identifiers and CMMS/BAS mappings are preserved alongside construction identifiers.
- A lightweight read-only viewer and open exports are required deliverables for durable access.
- Operations updates create later commits without rewriting construction closeout.
...
| ----------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CONHAND-001 | P0       | A handoff package shall include scope, accepted scene commit, asset inventory, verified attributes, documents, tests, warranties, training, open issues, exclusions, exports, and checksums. | Controlled verification |
| CONHAND-002 | P0       | The system shall validate required owner fields and documents by equipment/system type.                                                                                                      | Automated test          |
| CONHAND-003 | P0       | IFC/CSV/API exports shall state which values are verified, design-derived, observed, or inferred.                                                                                            | Automated test          |
| CONHAND-004 | P1       | Facility users shall search by location, tag, manufacturer/model, system, document, and issue history.                                                                                       | Controlled verification |
| CONHAND-005 | P1       | Operations changes shall retain continuity to construction entities and IDs where possible.                                                                                                  | Controlled verification |
| CONHAND-006 | P1       | A portability test shall confirm the owner can access core records without the production SIP service.                                                                                       | Controlled verification |
    ...
    - A versioned `con_hand_manifest` recording identity, timestamps, ownership, state, and provenance.
