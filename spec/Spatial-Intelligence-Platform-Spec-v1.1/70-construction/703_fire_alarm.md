---
spec_id: CON-FA
title: "Fire Alarm Spatial Documentation"
version: 1.1.0
...
normative: true
---
# Fire Alarm Spatial Documentation

    ## 1. Purpose

    Defines panels, annunciators, network nodes, devices, circuits, interfaces, notification zones, programming evidence, testing, and migration context.
    ...
    - The module documents life-safety systems but never controls or programs them through an unrestricted AI agent.
- Observed device identity, panel/circuit association, design association, and tested association are separate assertions.
- Panel interiors, labels, programming backups, and network/security details receive restricted classification.
- NFPA/code compliance judgments require qualified review and applicable adopted-code context.
...
| --------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| CONFA-001 | P0       | Fire-alarm entities shall support control units, power supplies, annunciators, amplifiers, network interfaces, initiating devices, notification appliances, modules, circuits/loops, interfaces, zones, and related equipment. | Controlled verification |
| CONFA-002 | P0       | A device record shall support manufacturer/model, address/label, panel/loop/circuit, location, mount/condition, drawing reference, photograph, source class, and verification/test status.                                     | Controlled verification |
| CONFA-003 | P0       | The system shall allow spatial comparison of observed devices against design drawings without automatically declaring code deficiency.                                                                                         | Controlled verification |
| CONFA-004 | P1       | Test records shall include procedure, result, witnesses, instrument where relevant, time, device association, and supporting media/document.                                                                                   | Controlled verification |
| CONFA-005 | P1       | Programming files and credentials shall be stored through restricted asset policies and never rendered in ordinary reports.                                                                                                    | Controlled verification |
| CONFA-006 | P1       | Migration planning shall preserve existing-system evidence, interfaces, affected areas, temporary protection notes, and phased changes.                                                                                        | Controlled verification |
    ...
    - A versioned `con_fa_manifest` recording identity, timestamps, ownership, state, and provenance.
