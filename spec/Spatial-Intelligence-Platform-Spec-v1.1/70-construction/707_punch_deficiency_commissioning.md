---
spec_id: CON-QC
title: "Deficiencies, Punch, Testing, and Commissioning"
version: 1.1.0
...
normative: true
---
# Deficiencies, Punch, Testing, and Commissioning

    ## 1. Purpose

    Defines issue creation, spatial evidence, assignments, severity, corrective action, retest, acceptance, and closeout.
    ...
    - An issue is linked to the scene commit and evidence that existed when it was observed.
- Closed does not delete the issue; it records corrective and verification evidence.
- Life-safety severity and contractual priority are distinct fields.
- Automated detections create proposed issues, never final deficiencies without review.
...
| --------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CONQC-001 | P0       | An issue shall include type, description, location/entity, observed commit/time, evidence, reporter, severity, responsible party, due date, status, and permissions. | Controlled verification |
| CONQC-002 | P0       | Corrective action shall link new evidence and changed scene/entity revision.                                                                                         | Controlled verification |
| CONQC-003 | P0       | Closure shall require configured verification, verifier, date, result, and residual limitations.                                                                     | Controlled verification |
| CONQC-004 | P1       | Commissioning tests shall support procedures, prerequisites, steps, expected/actual results, participants, instruments, attachments, and retest history.             | Controlled verification |
| CONQC-005 | P1       | Reports shall show open, overdue, disputed, corrected-awaiting-test, and closed issues with spatial summaries.                                                       | Controlled verification |
| CONQC-006 | P1       | Restricted system details shall remain protected in notifications and broad reports.                                                                                 | Controlled verification |
    ...
    - A versioned `con_qc_manifest` recording identity, timestamps, ownership, state, and provenance.
