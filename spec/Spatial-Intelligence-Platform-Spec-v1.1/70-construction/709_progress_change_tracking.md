---
spec_id: CON-PROG
title: "Construction Progress and Change Tracking"
version: 1.1.0
...
normative: true
---
# Construction Progress and Change Tracking

    ## 1. Purpose

    Defines repeated capture, comparable viewpoints, installation-state classification, quantity/progress evidence, and temporal reports.
    ...
    - Progress is based on accepted evidence and workflow definitions, not photoreal appearance alone.
- Repeated capture uses planned routes, overlap, and comparable quality targets.
- Object/install status and geometric change are separate signals.
- Payment or percent-complete assertions require project-defined human approval.
...
| ----------- | -------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CONPROG-001 | P0       | A progress visit shall reference baseline commit, scope, planned areas, comparable coverage, and capture quality. | Controlled verification |
| CONPROG-002 | P0       | Change detection shall classify installed, removed, moved, modified, occluded, unobserved, and uncertain.         | Controlled verification |
| CONPROG-003 | P0       | Progress states shall be defined per work item/system and linked to evidence and responsible reviewer.            | Controlled verification |
| CONPROG-004 | P1       | The system shall not infer payment entitlement from visual progress.                                              | Controlled verification |
| CONPROG-005 | P1       | Reports shall include comparable-region coverage and limitations to prevent false completeness.                   | Automated test          |
| CONPROG-006 | P1       | Time-lapse views shall preserve restricted-area and worker-privacy policy.                                        | Controlled verification |
    ...
    - A versioned `con_prog_manifest` recording identity, timestamps, ownership, state, and provenance.
