---
spec_id: CON-OVR
title: "Construction Spatial Reference Overview"
version: 1.1.0
...
normative: true
---
# Construction Spatial Reference Overview

    ## 1. Purpose

    Defines the construction product built on SIP for existing conditions, systems, bid reference, progress, commissioning, and owner handoff.
    ...
    - The product is a spatial reference and evidence system, not an automatic professional certification service.
- Design, observed, verified as-built, proposed, and historical conditions are separate branches and source classes.
- Field capture supports rapid walkthrough plus high-detail evidence passes.
- Fire alarm, access control, BAS/mechanical/electrical, drawings/RFIs, deficiencies, and closeout share a common entity/task model.
- Sensitive security and life-safety details are restricted by default.
...
| ---------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CONOVR-001 | P0       | A project shall organize site, building, level, zone, room, system, entity, document, visit, capture, task, and scene history.                                         | Controlled verification |
| CONOVR-002 | P0       | Users shall be able to navigate from a spatial object to photographs, nameplates, drawings, specifications, RFIs, submittals, tests, deficiencies, and prior versions. | Controlled verification |
| CONOVR-003 | P0       | The platform shall display measurement origin and verification state everywhere a quantity can affect estimating or installation.                                      | Controlled verification |
| CONOVR-004 | P1       | A field visit shall produce a completeness and unresolved-question report.                                                                                             | Controlled verification |
| CONOVR-005 | P1       | Owner handoff shall export open data and a read-only experience independent of a proprietary subscription where contractually required.                                | Controlled verification |
| CONOVR-006 | P1       | Construction reports shall identify scene commit, capture date, author, limitations, and evidence links.                                                               | Controlled verification |
    ...
    - A versioned `con_ovr_manifest` recording identity, timestamps, ownership, state, and provenance.
