---
spec_id: CAP-QUAL
title: "Live Capture Guidance and Coverage Quality"
version: 1.1.0
...
normative: true
---
# Live Capture Guidance and Coverage Quality

    ## 1. Purpose

    Defines operator feedback for blur, exposure, glare, distance, parallax, tracking, depth validity, coverage, and repeated-scene risk.
    ...
    - Guidance is actionable and prioritized to avoid overwhelming the operator.
- Coverage maps distinguish observed, high-quality, low-quality, and inferred regions.
- Capture continues only when policy permits degraded data and the event is recorded.
- Quality models are advisory unless validated and approved for automated rejection.
...
| ----------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CAPQUAL-001 | P0       | The app shall compute lightweight blur, exposure, motion, tracking, depth-coverage, and viewpoint-diversity signals during capture. | Controlled verification |
| CAPQUAL-002 | P0       | The app shall identify unvisited or weakly observed surfaces in the local map when feasible.                                        | Controlled verification |
| CAPQUAL-003 | P0       | A quality warning shall state cause, consequence, and corrective action.                                                            | Controlled verification |
| CAPQUAL-004 | P1       | Operator overrides shall be recorded with reason and cannot relabel degraded data as passing.                                       | Controlled verification |
| CAPQUAL-005 | P1       | Finalization shall generate a room/segment quality summary and recommended recapture list.                                          | Controlled verification |
| CAPQUAL-006 | P1       | Quality thresholds shall be versioned by capture profile and device class.                                                          | Controlled verification |
    ...
    - A versioned `cap_qual_manifest` recording identity, timestamps, ownership, state, and provenance.
