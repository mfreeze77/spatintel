---
spec_id: CAP-PRIV
title: "Capture-Time Privacy and Sensitive-Region Controls"
version: 1.1.0
...
normative: true
---
# Capture-Time Privacy and Sensitive-Region Controls

    ## 1. Purpose

    Defines consent notices, no-capture zones, sensitive-object marks, private narration, redaction previews, and controlled originals.
    ...
    - Privacy policy is loaded before capture and can disable disallowed sensors or destinations.
- Redaction is represented as policy and derived assets; the original remains controlled unless deletion is required.
- Spatial privacy volumes can hide regions across geometry, images, video, search, and exports.
- Construction security systems and LiveForever intimate spaces have elevated default classifications.
...
| ----------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| CAPPRIV-001 | P0       | The app shall display capture/recording status and consent context appropriate to the project.                                            | Controlled verification |
| CAPPRIV-002 | P0       | Operators shall be able to mark faces, screens, documents, license plates, security equipment, rooms, or arbitrary regions as restricted. | Controlled verification |
| CAPPRIV-003 | P0       | Automatic detectors shall create reviewable suggestions, not irreversible deletions.                                                      | Controlled verification |
| CAPPRIV-004 | P1       | Derived redacted media shall link to the source and exact redaction operations.                                                           | Controlled verification |
| CAPPRIV-005 | P1       | A public or broad-share export shall fail closed when required redactions are unresolved.                                                 | Controlled verification |
| CAPPRIV-006 | P1       | Private audio notes shall not be included in ordinary scene playback without explicit publication.                                        | Controlled verification |
    ...
    - A versioned `cap_priv_manifest` recording identity, timestamps, ownership, state, and provenance.
