...
# Master Test Strategy
    ...
    Defines the layered verification program for mobile capture, schemas, services, geometry, agents, vertical workflows, security, privacy, and operations.
    ...
    - Tests are organized by requirements and risk, not only by code module.
- Geometry and AI quality require quantitative datasets plus field review.
- Security/privacy/license tests are release gates, not optional audits after launch.
- Production monitoring validates assumptions that cannot be fully tested pre-release.
...
| ------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| TSTSTRAT-001 | P0       | Every P0 requirement shall map to an automated test, controlled field procedure, review artifact, or continuously monitored control.                                                         | Controlled verification |
| TSTSTRAT-002 | P0       | Test evidence shall include input hashes, environment, version, output, result, thresholds, and reviewer when manual.                                                                        | Automated test          |
| TSTSTRAT-003 | P0       | The strategy shall cover unit, property, contract, integration, end-to-end, field, benchmark, load, resilience, security, privacy, accessibility, migration, backup, and acceptance testing. | Controlled verification |
| TSTSTRAT-004 | P1       | Failed critical tests shall block release unless an allowed waiver with compensating control exists.                                                                                         | Controlled verification |
| TSTSTRAT-005 | P1       | Test data shall be synthetic or consented and follow retention/access policy.                                                                                                                | Controlled verification |
| TSTSTRAT-006 | P1       | Flaky tests shall be quarantined only with owner and expiry and cannot represent sole P0 evidence.                                                                                           | Controlled verification |
    ...
    - A versioned `tst_strat_manifest` recording identity, timestamps, ownership, state, and provenance.
