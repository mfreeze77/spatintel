---
spec_id: DEL-ROAD
title: "Product and Research Roadmap"
version: 1.1.0
...
# Product and Research Roadmap
    ...
    Defines sequenced capability growth from MVP through building-scale, enterprise construction, and durable memory experiences.
    ...
    - Roadmap sequencing follows platform leverage and risk retirement.
- Building-scale capture and automated semantics wait until room-scale truth/provenance is proven.
- Generated presence remains optional and later than preservation/evidence.
- Robotics and autonomous control remain outside the initial roadmap.
...
| ----------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| DELROAD-001 | P0       | Every roadmap item shall name prerequisites, customer outcome, architecture impact, risk, acceptance, and deprecation/migration implications. | Controlled verification |
| DELROAD-002 | P0       | Quarter labels shall not substitute for dependency-based sequencing.                                                                          | Controlled verification |
| DELROAD-003 | P0       | Research spikes shall have time bounds and decisions, not become unowned permanent forks.                                                     | Controlled verification |
| DELROAD-004 | P1       | Commercial dependencies shall have fallback/exit paths.                                                                                       | Controlled verification |
| DELROAD-005 | P1       | Roadmap review shall use pilot evidence, benchmark results, cost, support burden, and consent/security incidents.                             | Controlled verification |
| DELROAD-006 | P1       | The roadmap shall preserve local-only and open-export commitments as capabilities expand.                                                     | Controlled verification |
    ...
    - A versioned `del_road_manifest` recording identity, timestamps, ownership, state, and provenance.
...
## Version 1.1 roadmap insertion

Hybrid representation is a gated capability track between metric/visual reconstruction and vertical product expansion: (1) asset/authority schema, (2) provider governance, (3) local baseline, (4) support-map/anchor survival, (5) native hybrid runtime, (6) construction and LiveForever pilots, and only then (7) promoted research providers.
