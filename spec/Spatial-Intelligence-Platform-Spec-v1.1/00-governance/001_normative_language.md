---
spec_id: GOV-NORM
title: "Normative Language and Requirement IDs"
version: 1.1.0
...
# Normative Language and Requirement IDs
    ...
    Standardizes mandatory language, requirement identifiers, priority, verification methods, and interpretation so implementation teams cannot hide ambiguity.
    ...
    - Shall means mandatory, should means recommended with documented exception, and may means optional.
- P0 blocks production, P1 blocks the declared milestone unless waived, and P2 is planned optimization.
- Each requirement is atomic enough to test and names the observable behavior rather than a preferred library.
- Quantitative claims state input class, environment, percentile, and failure behavior.
...
| ----------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| GOVNORM-001 | P0       | Requirement identifiers shall remain stable after publication even when wording is clarified.                                                  | Controlled verification |
| GOVNORM-002 | P0       | A requirement shall have exactly one primary verification method and may list supplemental evidence.                                           | Controlled verification |
| GOVNORM-003 | P1       | Undefined terms shall be linked to the glossary or defined in the owning document.                                                             | Controlled verification |
| GOVNORM-004 | P1       | Words such as accurate, real-time, secure, reliable, and high-quality shall not appear in acceptance criteria without a measurable definition. | Controlled verification |
| GOVNORM-005 | P1       | Conflicting requirements shall be resolved through an architecture decision record rather than implementation guesswork.                       | Controlled verification |
    ...
    - A versioned `gov_norm_manifest` recording identity, timestamps, ownership, state, and provenance.
