---
spec_id: GOV-OPEN
title: "Assumptions, Open Questions, and Experiment Register"
version: 1.1.0
...
normative: true
---
# Assumptions, Open Questions, and Experiment Register

    ## 1. Purpose

    Maintains explicit uncertainty about research models, capture accuracy, commercial terms, customer workflows, and long-term preservation.
    ...
    - Unknowns are registered with owner, risk, proposed experiment, decision date, and downstream blockers.
- A provisional assumption cannot be cited as a verified product capability.
- Research findings are separated from production commitments.
- Expired assumptions automatically reopen the linked decision.
...
| ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| GOVOPEN-001 | P0       | The register shall include LingBot checkpoint licensing, supported hardware envelope, long-building drift, dynamic-scene behavior, and cross-session repeatability. | Controlled verification |
| GOVOPEN-002 | P0       | Each high-risk assumption shall have a falsifiable experiment and acceptance threshold.                                                                             | Controlled verification |
| GOVOPEN-003 | P1       | An experiment shall retain input hashes, environment, exact model, output, analysis, and conclusion.                                                                | Automated test          |
| GOVOPEN-004 | P1       | Decisions that depend on customer policy shall identify the policy owner and default-safe behavior.                                                                 | Controlled verification |
| GOVOPEN-005 | P1       | Unresolved P0 assumptions shall block release promotion.                                                                                                            | Controlled verification |
    ...
    - A versioned `gov_open_manifest` recording identity, timestamps, ownership, state, and provenance.
