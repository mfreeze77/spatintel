...
# Product and Engineering Principles
    ...
    Defines the rules used when requirements conflict or a future technology is not explicitly covered.
...
- Open data before lock-in.
- Reversible automation before irreversible convenience.
- Human authority before model confidence.
- Local ownership before unnecessary cloud transfer.
- One canonical model with multiple vertical experiences.
...
| ----------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| GOVPRIN-001 | P0       | Every automated transformation shall preserve a route back to source evidence.                                                                | Controlled verification |
| GOVPRIN-002 | P0       | A user shall be able to export their original assets, canonical manifests, scene metadata, and open-format derivatives.                       | Controlled verification |
| GOVPRIN-003 | P1       | Irreversible operations shall require explicit authority, impact preview, and auditable confirmation.                                         | Controlled verification |
| GOVPRIN-004 | P1       | The implementation shall expose uncertainty and disagreement rather than compressing them into one unlabeled score.                           | Controlled verification |
| GOVPRIN-005 | P1       | New verticals shall reuse the canonical scene and evidence model unless an approved architecture decision demonstrates a necessary extension. | Controlled verification |
    ...
    - A versioned `gov_prin_manifest` recording identity, timestamps, ownership, state, and provenance.
