---
spec_id: LIF-PRES
title: "Voice, Likeness, Avatar, and Simulated Presence"
version: 1.1.0
...
normative: true
---
# Voice, Likeness, Avatar, and Simulated Presence

    ## 1. Purpose

    Defines high-risk generated presence features, consent, model training, disclosure, restricted behaviors, and shutdown.
    ...
    - Voice clone, likeness, avatar, first-person dialogue, and interactive persona are separately consented capabilities.
- The default product can preserve recordings and narrate sourced stories without enabling an impersonating agent.
- Simulation never claims consciousness, current intent, legal authority, or supernatural contact.
- Generated responses remain grounded to approved memory evidence and persona boundaries.
...
| ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| LIFPRES-001 | P0       | A generated-presence consent shall define modality, purpose, audience, training data, providers, duration, posthumous behavior, prohibited topics/actions, and revocation/guardian process. | Controlled verification |
| LIFPRES-002 | P0       | Every generated interaction shall disclose simulation in the interface and retained session record.                                                                                         | Controlled verification |
| LIFPRES-003 | P0       | The persona shall not make legal, financial, medical, consent, inheritance, or relationship decisions on behalf of the subject.                                                             | Controlled verification |
| LIFPRES-004 | P1       | Outputs shall cite or expose grounding evidence and label imaginative synthesis.                                                                                                            | Controlled verification |
| LIFPRES-005 | P1       | Model training artifacts and biometric embeddings shall use highly restricted storage and deletion controls.                                                                                | Controlled verification |
| LIFPRES-006 | P1       | A kill switch shall immediately disable future generation while preserving authorized audit and source records.                                                                             | Controlled verification |
    ...
    - A versioned `lif_pres_manifest` recording identity, timestamps, ownership, state, and provenance.
