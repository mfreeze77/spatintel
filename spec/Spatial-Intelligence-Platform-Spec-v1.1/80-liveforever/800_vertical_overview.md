---
spec_id: LIF-OVR
title: "LiveForever Spatial Memory Overview"
version: 1.1.0
...
normative: true
---
# LiveForever Spatial Memory Overview

    ## 1. Purpose

    Defines a consent-driven experience that preserves people through sourced stories, places, objects, relationships, and media without confusing generation with truth.
    ...
    - The core unit is an evidence-backed memory graph connected to places and objects, not a chatbot imitation alone.
- The subject controls capture, processing, audience, generated likeness/voice, inheritance, and posthumous behavior through separable grants.
- Original interviews and media are immutable; transcripts, summaries, reconstructions, and experiences are derivatives.
- Contradictory recollections can coexist with context.
- Spatial experiences offer an evidence view and generated-content labels.
...
| ---------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| LIFOVR-001 | P0       | A LiveForever project shall represent subject, contributors, family/relationships, places, objects, events, memories, media, interviews, assertions, evidence, consent, audiences, and editions. | Automated test          |
| LIFOVR-002 | P0       | Every presented factual claim shall link to source evidence or be labeled as unsourced recollection/inference/generation.                                                                        | Controlled verification |
| LIFOVR-003 | P0       | Generated first-person dialogue, voice, likeness, or behavior shall require purpose-specific consent and persistent disclosure.                                                                  | Automated test          |
| LIFOVR-004 | P1       | A guardian/executor workflow shall define posthumous administration without silently expanding the subject's permissions.                                                                        | Controlled verification |
| LIFOVR-005 | P1       | Users shall be able to export original media, transcripts, memory graph, consent record, and open spatial assets.                                                                                | Controlled verification |
| LIFOVR-006 | P1       | The experience shall avoid claims of consciousness, certainty, or direct communication with the deceased.                                                                                        | Controlled verification |
    ...
    - A versioned `lif_ovr_manifest` recording identity, timestamps, ownership, state, and provenance.
