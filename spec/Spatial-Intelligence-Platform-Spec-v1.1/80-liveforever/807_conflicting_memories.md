---
spec_id: LIF-DISP
title: "Conflicting Memories, Corrections, and Family Disputes"
version: 1.1.0
...
normative: true
---
# Conflicting Memories, Corrections, and Family Disputes

    ## 1. Purpose

    Defines respectful coexistence, corroboration, private review, corrections, mediation, and edition choices when accounts differ.
    ...
    - The system preserves who said what and when.
- Corroboration increases support but does not automatically erase minority accounts.
- Family administrators cannot alter original testimony.
- Published editions can choose presentation while retaining underlying authorized records.
...
| ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| LIFDISP-001 | P0       | A dispute record shall identify assertions, contributors, issue, evidence, visibility, status, and resolution/edition decision.                        | Controlled verification |
| LIFDISP-002 | P0       | Corrections shall distinguish transcription correction, factual correction, contributor retraction, consent restriction, and alternate interpretation. | Controlled verification |
| LIFDISP-003 | P0       | A contributor shall be able to restrict their own account subject to agreed shared/preservation policy.                                                | Controlled verification |
| LIFDISP-004 | P1       | The system shall not use majority vote as proof of factual certainty.                                                                                  | Controlled verification |
| LIFDISP-005 | P1       | Agents shall present conflicts neutrally and cite sources rather than choosing a favorite account without policy.                                      | Controlled verification |
| LIFDISP-006 | P1       | Public editions shall disclose material unresolved disputes when omission would create a misleading narrative.                                         | Controlled verification |
    ...
    - A versioned `lif_disp_manifest` recording identity, timestamps, ownership, state, and provenance.
