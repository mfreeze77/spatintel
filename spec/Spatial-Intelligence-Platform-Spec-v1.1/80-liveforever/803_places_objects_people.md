---
spec_id: LIF-PLACE
title: "Places, Objects, People, and Relationships"
version: 1.1.0
...
normative: true
---
# Places, Objects, People, and Relationships

    ## 1. Purpose

    Defines identity and evidence for meaningful locations, keepsakes, furniture, routes, family members, friends, pets, and communities.
    ...
    - Places can have multiple historical configurations and names.
- Objects can move between places and owners over time.
- Person identity requires authorized evidence and does not rely solely on face recognition.
- Relationship labels can be asymmetric, time-bound, private, or disputed.
...
| ------------ | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| LIFPLACE-001 | P0       | Place records shall support address/region with privacy controls, names/aliases, time validity, scenes, maps, stories, and evidence.                     | Controlled verification |
| LIFPLACE-002 | P0       | Object records shall support physical description, ownership/custody history, spatial anchors, photographs, documents, stories, and preservation status. | Controlled verification |
| LIFPLACE-003 | P0       | Person records shall support names/aliases, relationships, audience/privacy, media consent, and identity evidence without requiring biometric templates. | Controlled verification |
| LIFPLACE-004 | P1       | Face or voice recognition suggestions shall remain private review items and use approved models/consent.                                                 | Controlled verification |
| LIFPLACE-005 | P1       | A memory shall be able to refer to an unidentified person or object without forced classification.                                                       | Controlled verification |
| LIFPLACE-006 | P1       | Deceased, living, minor, and public-figure subjects shall support different default consent/risk policies.                                               | Controlled verification |
    ...
    - A versioned `lif_place_manifest` recording identity, timestamps, ownership, state, and provenance.
