---
spec_id: LIF-GRAPH
title: "Memory Graph and Narrative Data Model"
version: 1.1.0
...
normative: true
---
# Memory Graph and Narrative Data Model

    ## 1. Purpose

    Defines memories as assertions/events linked to people, places, objects, times, relationships, themes, media, witnesses, and uncertainty.
    ...
    - A memory is not required to have an exact date or single location.
- First-person recollection, witness account, documented fact, synthesis, dispute, and artistic interpretation are distinct classes.
- Narrative ordering is an edition/view over the underlying graph.
- Memory identity survives edits to transcript wording or scene presentation.
...
| ------------ | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| LIFGRAPH-001 | P0       | A memory record shall include stable ID, title/working label, contributor, source class, time expression, place/object/person relationships, themes, emotional sensitivity, assertions, evidence, consent, and status. | Controlled verification |
| LIFGRAPH-002 | P0       | Approximate dates/locations shall use bounded or qualitative uncertainty rather than fabricated precision.                                                                                                             | Controlled verification |
| LIFGRAPH-003 | P0       | A narrative edition shall reference exact memory/assertion revisions and presentation choices.                                                                                                                         | Controlled verification |
| LIFGRAPH-004 | P1       | Family corrections shall create new assertions or revisions with provenance, not overwrite original testimony.                                                                                                         | Controlled verification |
| LIFGRAPH-005 | P1       | The graph shall support private, family, invited, memorial, and public audience scopes.                                                                                                                                | Controlled verification |
| LIFGRAPH-006 | P1       | Search and agents shall respect contributor-specific and subject-specific consent attached to graph elements.                                                                                                          | Controlled verification |
    ...
    - A versioned `lif_graph_manifest` recording identity, timestamps, ownership, state, and provenance.
