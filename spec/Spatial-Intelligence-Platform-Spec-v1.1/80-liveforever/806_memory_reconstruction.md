---
spec_id: LIF-REC
title: "Spatial and Temporal Memory Reconstruction"
version: 1.1.0
...
normative: true
---
# Spatial and Temporal Memory Reconstruction

    ## 1. Purpose

    Defines reconstruction of historical rooms, places, objects, atmosphere, and sequences from current scans, old media, testimony, maps, and documents.
    ...
    - Reconstruction layers are direct capture, source-constrained reconstruction, inferred completion, and artistic interpretation.
- Different years/eras are separate scene branches or commits.
- Missing geometry or appearance remains unknown unless explicitly reconstructed.
- The evidence view reveals source coverage and uncertainty by region/object.
...
| ---------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------- |
| LIFREC-001 | P0       | A reconstruction plan shall list target time/place, source assets, testimonies, known controls, gaps, assumptions, models, human decisions, and intended audience. | Controlled verification |
| LIFREC-002 | P0       | Every reconstructed region/entity shall carry source class, supporting evidence, confidence/uncertainty, and creator/model lineage.                                | Controlled verification |
| LIFREC-003 | P0       | Generated fill shall be togglable or visually inspectable separately from direct/source-constrained content.                                                       | Controlled verification |
| LIFREC-004 | P1       | Conflicting evidence shall create alternatives or disputed attributes rather than arbitrary hidden selection.                                                      | Controlled verification |
| LIFREC-005 | P1       | The platform shall preserve current capture and historical reconstruction as distinct states.                                                                      | Controlled verification |
| LIFREC-006 | P1       | A reconstruction edition shall include a limitations statement understandable to family viewers.                                                                   | Controlled verification |
    ...
    - A versioned `lif_rec_manifest` recording identity, timestamps, ownership, state, and provenance.
