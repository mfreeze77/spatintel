---
spec_id: LIF-LABEL
title: "AI Truth Labels and Evidence View"
version: 1.1.0
...
normative: true
---
# AI Truth Labels and Evidence View

    ## 1. Purpose

    Defines durable labels for direct capture, restoration, inference, synthesis, generation, testimony, corroboration, dispute, and uncertainty.
    ...
    - Labels are stored in canonical metadata and rendered in every supported experience/export profile.
- A single asset may contain regions with different source classes.
- Confidence is optional and never substitutes for source class.
- Evidence view is a primary navigation mode, not an administrator-only debug screen.
...
| ------------ | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| LIFLABEL-001 | P0       | The platform shall support at minimum: direct_capture, source_document, first_person_recollection, witness_recollection, corroborated_synthesis, inferred, reconstructed, restored, generated, artistic, disputed, and unknown. | Controlled verification |
| LIFLABEL-002 | P0       | Generated or reconstructed content shall retain model, prompt/instructions, inputs, operator decisions, and output hash where policy permits.                                                                                   | Automated test          |
| LIFLABEL-003 | P0       | The viewer shall show labels at first meaningful presentation and on demand at region/entity/assertion detail.                                                                                                                  | Controlled verification |
| LIFLABEL-004 | P1       | Static exports shall include legends and source labels that cannot be cropped away without altering the export artifact.                                                                                                        | Controlled verification |
| LIFLABEL-005 | P1       | Agents shall include source labels in factual answers and cannot paraphrase generated dialogue as a quote.                                                                                                                      | Controlled verification |
| LIFLABEL-006 | P1       | Automated tests shall verify labels survive scene commits, reports, share links, exports, and offline bundles.                                                                                                                  | Controlled verification |
    ...
    - A versioned `lif_label_manifest` recording identity, timestamps, ownership, state, and provenance.
