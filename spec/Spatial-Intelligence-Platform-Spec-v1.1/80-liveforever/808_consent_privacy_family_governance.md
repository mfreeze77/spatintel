---
spec_id: LIF-CONS
title: "Consent, Privacy, Family Governance, and Posthumous Administration"
version: 1.1.0
...
normative: true
---
# Consent, Privacy, Family Governance, and Posthumous Administration

    ## 1. Purpose

    Defines granular grants, guardians, executors, minors, living third parties, inheritance, disputes, revocation, and public editions.
    ...
    - Consent is purpose-, modality-, audience-, data-, provider-, and time-specific.
- Subject consent outranks convenience and cannot be broadened by a generic family-admin role.
- Posthumous representatives administer within the subject's recorded boundaries.
- Living third parties retain privacy interests in shared memories and media.
...
| ----------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| LIFCONS-001 | P0       | Consent records shall include grantor, authority basis, subject/data scope, processing purposes, modalities, audiences, providers, geography, effective/expiry, revocation, posthumous rules, and evidence. | Controlled verification |
| LIFCONS-002 | P0       | The policy engine shall evaluate all applicable subject, contributor, third-party, minor, and audience restrictions.                                                                                        | Controlled verification |
| LIFCONS-003 | P0       | A guardian/executor transition shall require documented authority and cannot enable prohibited generated presence.                                                                                          | Controlled verification |
| LIFCONS-004 | P1       | The system shall support sealed/private, family, named-invite, memorial-event, and public editions with separate assets if needed.                                                                          | Automated test          |
| LIFCONS-005 | P1       | Revocation shall stop new processing immediately and initiate derivative review/deletion/restriction according to policy.                                                                                   | Controlled verification |
| LIFCONS-006 | P1       | Disputed authority shall freeze high-risk changes while preserving access needed for due process and safety.                                                                                                | Controlled verification |
    ...
    - A versioned `lif_cons_manifest` recording identity, timestamps, ownership, state, and provenance.
