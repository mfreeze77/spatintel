...
const required = [
  ...
  "lib/spatial-runtime.ts", "lib/renderer.ts", "lib/hybrid-renderer.ts", "lib/local-scene-bundle.ts", "lib/cost-planner.ts", "lib/cost-planner-runtime.mjs", "components/CostEstimatePanel.tsx", "next.config.ts"
];
...
const checks = [
  ...
  ["lib/local-scene-bundle.ts", "parseLocalViewerBundle"], ["lib/local-scene-bundle.ts", "metric_unverified"],
  ...
  ["components/HybridCanvas.tsx", "re-resolved against metric evidence"], ["components/HybridViewer.tsx", "layers={layers}"], ["components/HybridViewer.tsx", "viewer-bundle.json"], ["components/HybridViewer.tsx", "Reduced motion"],
