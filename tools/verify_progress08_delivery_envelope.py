#!/usr/bin/env python3
"""Verify a consolidated Progress 08 delivery envelope and its nested project checkpoint."""
...
from tools.verify_progress08_checkpoint import verify_archive as verify_project_checkpoint
