#!/usr/bin/env python3
"""Verify a consolidated Progress 06 delivery envelope and its nested project checkpoint."""
...
from tools.verify_progress06_checkpoint import verify_archive as verify_project_checkpoint
