...
SERVICE_METADATA: dict[str, dict[str, Any]] = {
    ...
    "operations-intelligence": {
        "owner": "operations-reliability",
        "stores": ["postgresql", "object-store", "metrics-store", "trace-store"],
        "tables": [
            "telemetry_records", "resilience_profiles", "compute_profiles",
            "slo_definitions", "slo_measurements", "performance_budgets",
            "price_catalogs", "cost_estimates", "actual_costs",
            "budget_policies", "budget_reservations", "budget_overrides",
            "anomaly_alerts", "queue_snapshots", "capacity_plans",
            "cost_reconciliations", "support_access_grants", "support_bundles",
            "support_tickets", "game_day_exercises", "after_action_reviews",
            "incident_actions",
        ],
        "dependencies": [
            "identity-policy", "workflow-service", "audit-service",
