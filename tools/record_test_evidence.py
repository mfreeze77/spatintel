...
def main() -> None:
    ...
    print(json.dumps({"status": "passed", "reports": ["build/reports/python-test-report.json", "build/reports/swift-test-report.json", "build/reports/web-runtime-test-report.json"]}, indent=2))
