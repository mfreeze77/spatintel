...
def build(*, evidence_root: Path, output: Path, branch: str, attestation_path: Path) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="sip-progress-08-build-") as temporary:
        ...
        report = "\n".join([
            ...
            "",
            "Threat, privileged-access, workload-identity, key, privacy, audit, provider, runtime-safety, and supply-chain controls are implemented as the bounded Progress 08 OPS-002 milestone.",
            "",
            "Critical threats map to preventative, detective, and recovery controls; privileged and support access is short-lived and independently approved; provider outputs remain quarantined and release promotion remains fail-closed.",
            "",
