...
VERIFIED = {
    ...
    "ARCDEP-003", "ARCDEP-005", "OPSHYB-003", "OPSHYB-005",
...
IN_PROGRESS = {
    "CONDEMO-001", "DELDEV-004", "DELDOD-001",
...
IMPLEMENTATION_GROUPS: dict[str, list[str]] = {
    ...
    "ARCDEP": ["src/sip/deployment.py", "src/sip/api.py", "src/sip/assets.py", "src/sip/operations.py", "infrastructure/deployment/profiles", "infrastructure/compose/docker-compose.yml", "infrastructure/kubernetes/base", "infrastructure/terraform", "tools/validate_infrastructure.py"],
    ...
    "CONOVR": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/user/CONSTRUCTION.md"],
    "CONHIER": ["src/sip/construction.py", "src/sip/database.py", "docs/user/CONSTRUCTION.md"],
    "CONSURV": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/operator/CONSTRUCTION_VERTICAL_OPERATIONS.md"],
    "CONFA": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "docs/user/CONSTRUCTION.md"],
    "CONAC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0015_progress06_r1_security_controls.py", "docs/user/CONSTRUCTION.md"],
    "CONMEP": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0015_progress06_r1_security_controls.py", "docs/user/CONSTRUCTION.md"],
    "CONDOC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "migrations/versions/0015_progress06_r1_security_controls.py", "docs/user/CONSTRUCTION.md"],
    "CONQC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "migrations/versions/0015_progress06_r1_security_controls.py", "docs/operator/CONSTRUCTION_VERTICAL_OPERATIONS.md"],
    ...
    "DATEVID": ["src/sip/spatial_data.py", "src/sip/contracts.py", "src/sip/database.py", "src/sip/exporting.py", "src/sip/construction.py", "migrations/versions/0010_spatial_truth_and_twin_controls.py", "migrations/versions/0015_progress06_r1_security_controls.py"],
    ...
    "LIFCONS": ["src/sip/liveforever.py", "src/sip/policy.py", "src/sip/api.py", "src/sip/database.py", "src/sip/search.py", "src/sip/exporting.py", "migrations/versions/0015_progress06_r1_security_controls.py"],
    ...
    "LIFGRAPH": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/user/LIVEFOREVER.md"],
    "LIFINT": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/user/LIVEFOREVER.md"],
    "LIFPLACE": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "docs/user/LIVEFOREVER.md"],
    "LIFMEDIA": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "docs/user/LIVEFOREVER.md"],
    "LIFPRES": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "docs/user/LIVEFOREVER.md"],
    "LIFREC": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "docs/privacy/LIVEFOREVER_CONSENT_GOVERNANCE.md"],
    "LIFDISP": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/database.py", "docs/privacy/LIVEFOREVER_CONSENT_GOVERNANCE.md"],
    ...
    "OPSHYB": ["src/sip/deployment.py", "src/sip/security_ops.py", "src/sip/api.py", "src/sip/database.py", "infrastructure/deployment/profiles", "docs/operator/PROGRESS_09_DEPLOYMENT_RUNBOOK.md"],
    "OPSAWS": ["src/sip/deployment.py", "src/sip/api.py", "src/sip/database.py", "infrastructure/terraform/modules/aws-platform", "infrastructure/deployment/profiles/aws-reference.json", "docs/operator/PROGRESS_09_DEPLOYMENT_RUNBOOK.md"],
    ...
    "PLTVIEW": ["apps/web", "src/sip/scene_runtime.py", "src/sip/representations.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0012_scene_runtime_review.py", "tools/run_demo.py"],
    "PLTDESK": ["apps/desktop-review", "src/sip/desktop_review.py", "tests/integration/test_desktop_review.py"],
    "RECCHANG": ["src/sip/scene_runtime.py", "src/sip/database.py", "src/sip/api.py", "migrations/versions/0012_scene_runtime_review.py", "schemas/events"],
    ...
    "TSTSTRAT": ["tools/run_test_matrix.py", "tools/update_requirements.py", "src/sip/spec_lint.py", "tests/contract/test_progress06_r1_test_matrix_isolation.py", "requirements/requirements-ledger.json"],
}
...
SUPPLEMENTAL_EVIDENCE: dict[str, list[str]] = {
    ...
    "ARCDEP": ["build/reports/infrastructure-static-validation.json", "build/evidence/demo-progress09-deployment.json"],
    ...
    "CONOVR": ["build/evidence/demos/construction.json", "schemas/openapi/construction.openapi.json"],
    "CONHIER": ["build/evidence/demos/construction.json"],
    "CONSURV": ["build/evidence/demos/construction.json", "build/reports/tests/integration.xml"],
    "CONFA": ["build/evidence/demos/construction.json"],
    "CONAC": ["build/evidence/demos/construction.json"],
    "CONMEP": ["build/evidence/demos/construction.json"],
    "CONDOC": ["build/evidence/demos/construction.json", "build/reports/tests/contract.xml"],
    "CONQC": ["build/evidence/demos/construction.json", "build/reports/tests/integration.xml"],
    "CONPROG": ["build/evidence/demos/construction.json"],
    "CONHAND": ["build/evidence/demos/construction.json", "build/evidence/demos/export.json", "build/evidence/demos/restore.json"],
    "CONREP": ["build/evidence/demos/construction.json"],
    "DATBIM": ["build/evidence/demos/construction.json", "build/reports/tests/integration.xml"],
    "LIFGRAPH": ["build/evidence/demos/liveforever.json", "build/reports/tests/integration.xml"],
    "LIFINT": ["build/evidence/demos/liveforever.json"],
    "LIFPLACE": ["build/evidence/demos/liveforever.json"],
    "LIFMEDIA": ["build/evidence/demos/liveforever.json"],
    "LIFPRES": ["build/evidence/demos/liveforever.json"],
    "LIFREC": ["build/evidence/demos/liveforever.json", "build/reports/tests/privacy.xml"],
    "LIFDISP": ["build/evidence/demos/liveforever.json", "build/reports/tests/integration.xml"],
    "LIFLABEL": ["build/evidence/demos/liveforever.json"],
    ...
    "RECCHANG": ["build/evidence/demos/scene-runtime.json", "schemas/events/event-catalog.json"],
