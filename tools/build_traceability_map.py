...
IMPLEMENTATION_GROUPS: dict[str, list[str]] = {
    ...
    "HYBRUN": ["src/sip/hybrid.py", "src/sip/representations.py", "src/sip/scene.py", "src/sip/api.py", "apps/web/src", "tools/run_demo.py"],
    "HYBTEST": ["src/sip/geometry.py", "src/sip/representations.py", "src/sip/worker_sandbox.py", "tools/run_demo.py"],
    "LIFHYB": ["src/sip/liveforever.py", "src/sip/policy.py", "apps/web/src"],
    ...
    "PLTIO": ["src/sip/exporting.py", "src/sip/lifecycle.py", "tools/run_demo.py", "apps/web/src"],
    ...
    "PLTVIEW": ["apps/web/src", "src/sip/representations.py", "tools/run_demo.py"],
    ...
    "RECHYB": ["src/sip/representations.py", "src/sip/scene.py", "apps/web/src", "tools/run_demo.py"],
