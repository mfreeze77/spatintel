...
IMPLEMENTATION_GROUPS: dict[str, list[str]] = {
    ...
    "CONAC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "docs/user/CONSTRUCTION.md"],
    "CONMEP": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "docs/user/CONSTRUCTION.md"],
    "CONDOC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/user/CONSTRUCTION.md"],
    "CONQC": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/operator/CONSTRUCTION_VERTICAL_OPERATIONS.md"],
    "CONPROG": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "docs/operator/CONSTRUCTION_VERTICAL_OPERATIONS.md"],
    "CONHAND": ["src/sip/construction.py", "src/sip/api.py", "src/sip/archive_safety.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/operator/CONSTRUCTION_OWNER_HANDOFF.md"],
    "CONREP": ["src/sip/construction.py", "src/sip/api.py", "docs/user/CONSTRUCTION.md"],
    "DATBIM": ["src/sip/construction.py", "src/sip/api.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/developer/VERTICAL_MVP_ARCHITECTURE.md"],
    ...
    "LIFPRESV": ["src/sip/liveforever.py", "src/sip/api.py", "src/sip/archive_safety.py", "src/sip/database.py", "migrations/versions/0014_vertical_mvp.py", "docs/operator/LIVEFOREVER_PRESERVATION.md"],
