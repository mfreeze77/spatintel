#!/usr/bin/env python3
"""Run the Progress 06-R1 clean-source acceptance sequence and retain source-bound gate evidence."""
...
def run(*, attestation_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "release_block_reason": "Progress 06-R1 requires independent True North closure review; Progress 07 and production remain unauthorized, and external validation gaps remain open.",
    }
...
def main() -> None:
    ...
    readiness = {
        ...
        "next_action": "Submit the independently verified Progress 06-R1 inner checkpoint and consolidated outer envelope for True North closure review; Progress 07 and production remain unauthorized.",
    }
    readiness_path = ROOT / "build/reports/release-readiness-progress-06-r1.json"
