#!/usr/bin/env python3
"""Run the Progress 06-R2 clean-source acceptance sequence and retain source-bound gate evidence."""
...
def run(*, attestation_path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "release_block_reason": "Progress 06-R2 requires independent True North closure review; Progress 07 and production remain unauthorized, and external validation gaps remain open.",
    }
