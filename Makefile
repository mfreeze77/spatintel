...
security:
	...
	SIP_TEST_REPORT_ROOT=build/reports/security-direct PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=$(PYTHONPATH) $(PYTHON) tools/run_test_matrix.py --suite security --jobs 1 --shard-jobs 1 --timeout 300
